...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cursor = getContentResolver().query(MyProviderContract.RECIPE_URI, projection, null, null, MyProviderContract.sortOrder);
    ...
    */
    ...
    private void loadCategories() {
        ...
        category.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> adapterView, View view, int i, long l) {
                updateList(category.getSelectedItem().toString());
            }
    ...
    private void updateList(String category) {
        ...
        if (category.equalsIgnoreCase("all"))
            ...
            cursor = getContentResolver().query(MyProviderContract.RECIPE_URI, projection, "category LIKE ?", new String[]{category + "%"}, null, null);
